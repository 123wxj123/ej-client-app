    ...
    <div class="confirm_order">
      ...
      <van-row class="line">
        ...
        <van-col :span="18" class="line-right">
          ...
          <div>
            <div class="list">
              <confirm_order_address_item v-for="address in addresses" :key="address.id" :data="address"></confirm_order_address_item>
            </div>
            <!-- {{addresses}} -->
          </div>
        </van-col>
      ...
      <van-row class="line">
        ...
        <van-col :span="18" class="line-right">
          ...
          <div>
            ...
            <van-row v-for="line of orderLines.values()" :key="line.productId" class="price_details">
